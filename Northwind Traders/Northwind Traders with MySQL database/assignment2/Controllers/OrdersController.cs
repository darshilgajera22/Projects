...
namespace assignment2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        // GET: Orders
        public async Task<IActionResult> Index(int? pageNumber, int? pageRowsSize)
        {
            ...
            ViewBag.PageRowsSize = pageRowsSize;
            return View(await PaginatedList<Order>.CreateAsync(orders.AsNoTracking(), pageNumber ?? 1, pageRowsSize ?? 5));
        }
